...
| [Gradle KTS](https://docs.gradle.org/current/userguide/kotlin_dsl.html) (master & master_kts* branches) / [Groovy](https://groovy-lang.org/) (master_groovy branch) | Migrate build script from Groovy to Gradle KTS |
| [Material 3](https://m3.material.io/) (master & master_kts* branches) / [Material 2](https://m2.material.io/) (master_groovy branch) | Use the latest material design |
